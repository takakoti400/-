...
list = [
   mode = value.createList("Mode", ["MineplexCombat", "Lunar", "OnlyMC", "HazelMC", "NoPayload", "Offset", "C03 Cancel", "C06 Only", "VerusCombat", "VerusOld", "NaNPlace", "CustomPlace", "NaNPos", "CustomPos"], "MineplexCombat"),
